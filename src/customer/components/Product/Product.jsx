                          ...
                          <div key={option.value} className="flex gap-3">
                            <div className="flex h-5 shrink-0 items-center">
                              <div className="group grid size-4 grid-cols-1">
                                ...
                                <CheckIcon
                                  aria-hidden="true"
                                  className="pointer-events-none col-start-1 row-start-1 z-10 size-3.5 self-center justify-self-center text-white"
                                />
                              </div>
                            </div>
                            <label
                  ...
                  >
                    ...
                    <DisclosurePanel className="pt-6">
                      <div className="space-y-6">
                        <FormControl>
                          <RadioGroup
                            aria-labelledby={`demo-radio-buttons-group-label-mobile-${section.id}`}
                            value={searchParams.get(section.id) || ""}
                            name={`radio-buttons-group-mobile-${section.id}`}
                            onChange={(e) =>
